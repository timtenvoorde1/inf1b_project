                ...
                <div id="header">
                    ...
                    <div id="headertxt">
                        ...
                        <div class="language">
                            <ul>
                                <li>&#127760;</li>
                                <li class=""><a href="createplenagenda.php">NL</a></li>
                                <li class=""><a href="en/createplenagenda.php">EN</a></li>
                            </ul>
                        </div>
                    </div> 
                </div>
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            if (TableExistCheck($DBConnect, $DBName, $TableName) === TRUE) {
                                ...
                                if ($stmt = mysqli_prepare($DBConnect, $Query)) {
                                    mysqli_stmt_bind_param($stmt, 'siiis', $Cohort, $Year, $Period, $Week, $Tekst);
