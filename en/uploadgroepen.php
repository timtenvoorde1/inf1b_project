	...
	<div id="mainContainer">
		...
		<div id="formbox">
			...
			<form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <p><input type="text" name="schooljaar" placeholder="Schoolyear" required></p>
                            <p><input type="text" name="periode" placeholder="Period" required></p>
                            <div class="avatar">
                                <p class="color"><label>Select grouping: </label></p>
							...
							if (copy($_FILES['avatar']['tmp_name'], $imagepath))
							{
								...
								if ($stmt)
								{
									...
									if ($result === FALSE)
									{
										...
										echo "<h4>Succesfully uploaded!</h4>";
									}
